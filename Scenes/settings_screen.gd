...
func _ready():
	...
	tutorialMenu.addTutorialData("Welcome!", "Welcome to Rhythm Trainer, an app where you can practice sightreading music. Tap anywere to begin, then tap out the rhythm on your screen. If you make a mistake, you can always use the restart button in the upper right corner.", .5)
